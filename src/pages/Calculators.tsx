...
const Calculators = () => {
  ...
  const goldConversion = useMemo(() => {
    if (conversionType === 'carat-to-percentage') {
      ...
      return {
        result: Math.round(carat * 100) / 100,
        unit: 'K'
      };
    }
  ...
  const eligibilityCalculations = useMemo(() => {
    ...
    const eligibleAmount = maxEmi * 60 * creditMultiplier; // Assuming 60 months tenure
    
    const eligibilityScore = Math.min(100, 
      (disposableIncome / monthlyIncome * 40) + 
      (creditScore / 850 * 40) + 
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="mt-6">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center gap-2">
                              ...
                              <span>Principal ({Math.round((emiAmount / emiCalculations.totalAmount) * 100)}%)</span>
                            </div>
                        ...
                        <div className="mt-3">
                          <Progress 
                            value={(emiAmount / emiCalculations.totalAmount) * 100} 
                            className="h-2"
                          />
                        </div>
                      </div>
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select value={goldPurity.toString()} onValueChange={(value) => setGoldPurity(Number(value))}>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-semibold">{goldWeight} grams</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600">Purity</span>
                          <span className="font-semibold">{goldPurity}K ({goldLoanCalculations.purityPercentage}%)</span>
                        </div>
                        <div className="flex justify-between items-center">
                      ...
                      <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                        ...
                        <div className="text-xs text-blue-800">
                          Higher purity gold gets better loan amounts. Consider consolidating smaller gold items for better rates.
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    {conversionType === 'carat-to-percentage' ? (
                      <div>
                        ...
                        <Input
                          ...
                          type="number"
                          value={caratValue}
                          onChange={(e) => setCaratValue(Number(e.target.value) || 0)}
                          min="1"
                          max="24"
                          step="0.1"
                          className="mt-1"
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setPercentageValue(Number(e.target.value) || 0)}
                          min="1"
                          max="100"
                          step="0.1"
                          className="mt-1"
                    ...
                    <div className="text-center p-8 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg">
                      ...
                      <div className="text-4xl font-bold text-amber-600">
                        {goldConversion.result}{goldConversion.unit}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        {[
                          { karat: 24, percentage: 99.9 },
                          { karat: 22, percentage: 91.6 },
                          { karat: 20, percentage: 83.3 },
                          { karat: 18, percentage: 75.0 },
                          { karat: 16, percentage: 66.7 },
                          { karat: 14, percentage: 58.3 },
                          { karat: 12, percentage: 50.0 },
                          { karat: 10, percentage: 41.7 }
                        ].map((item) => (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <Badge variant="outline">{interestType === 'simple' ? 'Simple' : 'Compound'}</Badge>
                        </div>
                        <Separator />
                        <div className="flex justify-between items-center text-lg">
                          <span className="font-semibold">Total Amount</span>
                          <span className="font-bold text-primary">₹{interestCalculations.totalAmount.toLocaleString()}</span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="text-center">
                        ...
                        <div className="relative w-32 h-32 mx-auto">
                          ...
                          <Progress 
                            value={eligibilityCalculations.eligibilityScore} 
                            className="h-4 w-32 rotate-90 origin-center"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center p-4 bg-blue-50 rounded-lg">
                          <div className="text-xs text-gray-600 mb-1">Max EMI</div>
                          <div className="text-lg font-bold text-blue-600">₹{eligibilityCalculations.maxEmi.toLocaleString()}</div>
                        </div>
                        <div className="text-center p-4 bg-green-50 rounded-lg">
                          <div className="text-xs text-gray-600 mb-1">Eligible Amount</div>
                          <div className="text-lg font-bold text-green-600">₹{eligibilityCalculations.eligibleAmount.toLocaleString()}</div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-semibold">₹{existingEmi.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600">Disposable Income</span>
                          <span className="font-semibold text-green-600">₹{eligibilityCalculations.disposableIncome.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between items-center">
                      ...
                      <div className="mt-4 p-3 bg-indigo-50 rounded-lg">
                        <div className="text-xs text-indigo-600 font-medium mb-1">💡 Tips to Improve Eligibility</div>
                        <ul className="text-xs text-indigo-800 space-y-1">
                          <li>• Increase monthly income through additional sources</li>
                          <li>• Reduce existing EMI burden</li>
                          <li>• Improve credit score by timely payments</li>
                        </ul>
                      </div>
                    </div>
                  </CardContent>
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 max-w-md mx-auto">
                      Compare different loan options side by side with detailed analysis of terms, 
